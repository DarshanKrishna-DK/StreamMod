          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-100 mb-8 max-w-3xl mx-auto">
                The future of live streaming with AI-powered moderation. 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 text-center hover:bg-gray-100 transition-colors duration-300 shadow-lg">
                ...
                <p className="text-gray-600">
                  Built with security and privacy in mind for safe streaming
                </p>
              </div>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 text-center hover:bg-gray-100 transition-colors duration-300 shadow-lg">
                ...
                <p className="text-gray-600">
                  Simple and intuitive interface for streamers and viewers
                </p>
              </div>
            </div>
          </div>
