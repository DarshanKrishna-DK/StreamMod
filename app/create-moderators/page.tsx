  ...
  const connectTwitch = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        alert(`Successfully connected to Twitch channel: ${twitchChannel}`);
      }, 1000);
    } catch (error) {
          ...
          {selectedPlatform && selectedModerators.length > 0 && (!selectedModerators.some(mod => mod.requiresMCP) || selectedMCP) && (
            <div className="flex justify-end">
              <button
                ...
                className="flex items-center px-8 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg font-semibold hover:from-purple-700 hover:to-pink-700 transition-all"
              >
