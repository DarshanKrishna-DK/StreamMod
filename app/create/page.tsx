      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="space-y-2">
                {selectedModerators.map((modId) => {
                  ...
                  return (
                    <div key={modId} className="flex justify-between text-sm">
                      ...
                      <span className="text-gray-900">${moderator?.pricePerHour}/hr</span>
                    </div>
                  );
                })}
                <div className="border-t pt-2 mt-2">
                  <div className="flex justify-between font-semibold">
                    ...
                    <span className="text-gray-900">${totalCostPerHour.toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between font-bold text-lg">
                    <span className="text-gray-900">Estimated total ({estimatedDuration}h):</span>
                    <span className="text-purple-600">${totalEstimatedCost.toFixed(2)}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex justify-end">
            <button
              onClick={startStream}
              disabled={!streamTitle || !category || selectedModerators.length === 0}
