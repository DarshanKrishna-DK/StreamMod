...
import { hardhat, avalanche } from "viem/chains";
...
// We always want to have Avalanche mainnet enabled for price feeds, etc. But only once.
export const enabledChains = targetNetworks.find((network: Chain) => network.id === 43114)
  ? targetNetworks
  : ([...targetNetworks, avalanche] as const);
